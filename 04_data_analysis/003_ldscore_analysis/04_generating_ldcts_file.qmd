...
directory <- paste0("/scratch/scw1329/gmbh/blood-brain-barrier-in-ad/", directory, "/")
...
files <- sort(files)
files <- str_replace_all(files, "-", "_")

## Exclude the top 5% files as a test
files <- files[!grepl("top_five_percent", files)]
...
labels_background <- str_replace(background_files, "background_genes_ldsc_", "")
