...
new_labels <- str_replace_all(current_labels, "Capillary|Venous|Arterial", "Endothelial") %>%
  ...
  str_replace_all("arteriolar-SMC", "mystery-cluster") %>%
...
updated_meta$apoe_status <- ifelse(is.na(updated_meta$apoe_status), updated_meta$APOE, updated_meta$apoe_status)
# remove old column
updated_meta$APOE <- NULL
