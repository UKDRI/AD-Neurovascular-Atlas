...
#SBATCH --mem=240G # memory limit per compute node for the job
...
## results
OUTPUT_DIR="/scratch/c.mpmgb/blood-brain-barrier-in-ad/03_data/990_processed_data/001_snrnaseq/04_cellranger_count/02_set2"

## original sample IDs, correpond to FASTQ file names
SAMPLE_ID_FILE="/scratch/c.mpmgb/blood-brain-barrier-in-ad/03_data/990_processed_data/001_snrnaseq/90_sample_info/samples_set2_4_runs.txt"

## corresponding new sample names to be set by --id
SAMPLE_ID_NEW_FILE="/scratch/c.mpmgb/blood-brain-barrier-in-ad/03_data/990_processed_data/001_snrnaseq/90_sample_info/samples_set2_rename.txt"
