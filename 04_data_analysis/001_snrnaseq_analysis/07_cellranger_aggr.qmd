...
awk -v line="sample_id,molecule_h5" 'BEGIN{print line}{print}' cellranger_ag3.txt > cellranger_ag.csv

# clean up
rm cellranger_ag.txt cellranger_ag2.txt cellranger_ag3.txt
```
