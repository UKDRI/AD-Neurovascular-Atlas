...
grep "01_set1" cellranger_ag4.txt > cellranger_ag_set1.txt
grep "02_set2" cellranger_ag4.txt > cellranger_ag_set2.txt
grep "03_set3" cellranger_ag4.txt > cellranger_ag_set3.txt
...
awk -v line="sample_id,molecule_h5" 'BEGIN{print line}{print}' cellranger_ag4.txt > cellranger_aggr_all_sets.csv
...
# clean up
rm cellranger_ag.txt cellranger_ag2.txt cellranger_ag3.txt cellranger_ag_set1.txt cellranger_ag_set2.txt cellranger_ag_set3.txt cellranger_ag4.txt
```
