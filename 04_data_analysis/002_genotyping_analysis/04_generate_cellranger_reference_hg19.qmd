---
title: Generate GRCh37 reference
execute: 
  eval: false
---

Need to generate a hg19 cellranger reference, docs for this can be found [here](https://support.10xgenomics.com/single-cell-gene-expression/software/release-notes/build#hg19_3.0.0).
Need to modify the contigs as with the GRCh38 reference.
