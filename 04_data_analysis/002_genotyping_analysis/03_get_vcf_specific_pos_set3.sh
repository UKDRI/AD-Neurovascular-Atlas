...
#SBATCH --job-name=geneotyping_bbb_set3
#SBATCH --ntasks=20
...
BAM_DIR="03_data/990_processed_data/001_snrnaseq/04_cellranger_count/03_set3/"
...
## output VCF files
OUTPUT_DIR="/scratch/scw1329/gmbh/blood-brain-barrier-in-ad/03_data/992_genotyping_data/01_vcf_specific_position/03_set3"
