...
BAM_DIR="03_data/990_processed_data/001_snrnaseq/04_cellranger_count/01_set1/"
# BAM_DIR="03_data/990_processed_data/001_snrnaseq/04_cellranger_count/0${SET_NUM}_set${SET_NUM}/"
...
## output VCF files
OUTPUT_DIR="/scratch/scw1329/gmbh/blood-brain-barrier-in-ad/03_data/992_genotyping_data/01_vcf_specific_position/01_set1"
# OUTPUT_DIR="/scratch/scw1329/gmbh/blood-brain-barrier-in-ad/03_data/992_genotyping_data/01_vcf_specific_position/0${SET_NUM}_set${SET_NUM}"
