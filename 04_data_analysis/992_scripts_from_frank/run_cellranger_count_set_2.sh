...
## results
OUTPUT_DIR="/scratch/c.mpmfw/Endo_10X_main/Analysis/CellRanger_count/CellRanger_count_v701_ensembl_108_set_2_R2_full"

## original sample IDs, correpond to FASTQ file names
SAMPLE_ID_FILE="/scratch/c.mpmfw/Endo_10X_main/Analysis/Samples_info/samples_set2_4_runs.txt"

## corresponding new sample names to be set by --id
SAMPLE_ID_NEW_FILE="/scratch/c.mpmfw/Endo_10X_main/Analysis/Samples_info/samples_set2_rename.txt"

## CR executable
### CELL_RANGER="/scratch/c.mpmfw/Tools/CellRanger/cellranger-6.1.1/bin/cellranger"
CELL_RANGER="/scratch/c.mpmfw/Tools/CellRanger/cellranger-7.0.1/bin/cellranger"
...
CR_REF="/scratch/c.mpmfw/Tools/CellRanger/CellRanger_references/CR_reference_ensembl/GRCh38"
