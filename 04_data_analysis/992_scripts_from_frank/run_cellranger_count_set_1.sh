...
## results
OUTPUT_DIR="/scratch/c.mpmfw/Endo_10X_main/Analysis/CellRanger_count/CellRanger_count_v701_ensembl_108_set_1_R2_full"

## original sample IDs, correpond to FASTQ file names
SAMPLE_ID_FILE="/scratch/c.mpmfw/Endo_10X_main/Analysis/Samples_info/samples_set1_IDs.txt"
...
SAMPLE_ID_NEW_FILE="/scratch/c.mpmfw/Endo_10X_main/Analysis/Samples_info/samples_set1_IDs_swap.txt"
