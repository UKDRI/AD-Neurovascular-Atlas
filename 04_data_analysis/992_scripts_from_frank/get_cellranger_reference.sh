...
#SBATCH -o /scratch/c.mpmfw/Hawk_output/%x_out_%J.txt
#SBATCH -e /scratch/c.mpmfw/Hawk_output/%x_err_%J.txt
...
REF_DIR="/scratch/c.mpmfw/Tools/CellRanger/CellRanger_references/CR_reference_ensembl"
cd $REF_DIR

# Genome metadata
genome="GRCh38"
version="2022_"${ENSEMBL_VER}

# Set up source and build directories
build="GRCh38_2022_"${ENSEMBL_VER}
mkdir -p "$build"

# Download source files if they do not exist in reference_sources/ folder
source="reference_sources_"${ENSEMBL_VER}
mkdir -p "$source"
