...
## BAM_DIR="/scratch/c.mpmfw/Endo_10X_main/Analysis/CellRanger_count/CellRanger_count_v700_ensembl_106_set_1_R2_full/"
BAM_DIR="/scratch/c.mpmfw/Endo_10X_main/Analysis/CellRanger_count/CellRanger_count_v700_ensembl_106_set_2_R2_full/"

## reference fasta file provided by Cell Ranger, part of reference download from website
CR_REF="/scratch/c.mpmfw/Tools/CellRanger/CellRanger_references/CR_reference_GRCh38_ensembl/GRCh38/fasta/genome.fa"
...
## output VCF files
## OUTPUT_DIR="/scratch/c.mpmfw/Endo_10X_main/Analysis/Genotyping/VCF_POS/Set_1_NeuroChip_R2_full/"
OUTPUT_DIR="/scratch/c.mpmfw/Endo_10X_main/Analysis/Genotyping/VCF_POS/Set_2_NeuroChip_R2_full/"

## 24 main chromosomes: as specified in Cell Ranger BAM files: chr1, chr2 ... chr22, chrX, chrY
MAIN_CHR="/scratch/c.mpmfw/Endo_10X_main/Analysis/Genotyping/main_chromosomes_grch38_Cell_Ranger.txt"
...
POS_FILE="/scratch/c.mpmfw/Endo_10X_main/Analysis/Genotyping/NeuroChip_v1_positions_liftover_GRCh38.txt"
