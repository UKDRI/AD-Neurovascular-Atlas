...
INPUT_DIR_RNA="/Users/frankwessely/Desktop/Documents/Projects/BBB/Endo_10X_Main/Analysis/Genotyping/VCF/Set_1_2_combined_R2_full/"

## store .gz VCF files and index
OUTPUT_DIR="/Users/frankwessely/Desktop/Documents/Projects/BBB/Endo_10X_Main/Analysis/Genotyping/Comparisons/Compare_40_samples_DNA_RNA_filtered/"
...
find $INPUT_DIR_RNA -maxdepth 1 -name '*_raw.vcf' > filenames_1.tmp
...
find $INPUT_DIR_DNA -maxdepth 1 -name '*.vcf' > filenames_1.tmp
